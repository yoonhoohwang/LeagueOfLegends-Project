  ...
  <vue-scroll class="page-dashboard">
          ...
          <div class="widget-header ph-20 pt-20">
            <div class="flex justify-center align-center">
              <div class="widget-icon-box mr-20 animated fadeInRight">
                ...
                <div class="badge-box">
                  <span class="badge">
                    <i class="mdi mdi-trending-up success-text mr-10"></i>
                    <strong class="accent-text">16%</strong>
                  </span>
                </div>
              </div>
      ...
      <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
        ...
        >
            ...
            <div class="flex justify-center align-center">
              <div class="widget-icon-box mr-20 animated fadeInRight">
                ...
                <div class="badge-box">
                  <span class="badge">
                    <i class="mdi mdi-trending-up success-text mr-10"></i>
                    <strong class="accent-text">11%</strong>
                  </span>
                </div>
              </div>
              <div class="widget-info box grow text-truncate animated fadeInLeft">
          ...
          <component
            :is="asyncComponent"
            :type="'bar'"
            :options="{ width: "100%", height: 80, fill: ["#c6d9fd"] }"
            :data="[1, 3, 2, 4, 4, 9, 3, 4, 6, 5, 4, 6, 9, 8, 7, 6, 5, 12, 10, 9].toString()"
          />
        </div>
      </el-col>
      <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
        ...
        >
          <div class="widget-header ph-20 pt-20">
            <div class="flex justify-center align-center">
              <div class="widget-icon-box mr-20 animated fadeInRight">
                ...
                <div class="badge-box">
                  <span class="badge">
                    <i class="mdi mdi-trending-neutral info-text mr-10"></i>
          ...
          <component
            :is="asyncComponent"
            :type="'line'"
            :options="{ width: "100%", height: 80, fill: "#56f19a", stroke: "#67C23A" }"
            :data="[10, 7, 8, 5, 4, 9, 3, 4, 6, 5, 4, 4, 2, 4, 5, 9, 13, 12, 12, 14].toString()"
          />
        </div>
      </el-col>
      <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
        ...
        >
            ...
            <div class="flex justify-center align-center">
              <div class="widget-icon-box mr-20 animated fadeInRight">
                ...
                <div class="badge-box">
                  <span class="badge">
                    <i class="mdi mdi-trending-neutral info-text mr-10"></i>
                    <strong class="success-text">0%</strong>
                  </span>
                </div>
              </div>
              <div class="widget-info box grow text-truncate animated fadeInLeft">
          ...
          <component
            ...
            :data="[6, 5, 4, 3, 5, 3, 4, 5, 6, 5, 4, 2, 3, 8, 7, 6, 5, 2, 1, 5].toString()"
          />
        </div>
      </el-col>
    ...
    <el-row class="mt-30" :gutter="30">
      ...
      <el-col :xs="24" :sm="12" :md="10" :lg="8" :xl="6">
        <div
          class="card-base card-shadow--medium mb-30 bg-primary p-20"
          style="height:410px; box-sizing:border-box;"
          v-loading="!asyncChart2"
        >
    ...
    <el-row class="mt-0" :gutter="30">
      <el-col :xs="24" :sm="12" :md="10" :lg="8" :xl="6">
        <vue-scroll class="card-base card-shadow--medium p-20 mb-30" style="height:660px">
          ...
          <h4 class="mt-5 mb-40 animated slideInUp">
            <span class="o-050">Last activity:</span>
            <strong class="ml-10 o-070">2 days ago</strong>
          </h4>
          ...
          <timeline timeline-theme="lightblue">
            ...
            <timeline-item
              :hollow="true"
            >Lorem ipsum dolor sit amet conse ctetur which ascing elit users.</timeline-item>
            <timeline-item :hollow="true">Donec dapibus molestie lacus ac pellentesque.</timeline-item>
            <timeline-title>3 days ago</timeline-title>
            <timeline-item
              :hollow="true"
            >Mauris vitae posuere arcu. Donec porta ex sed hendrerit euismod.</timeline-item>
            <timeline-title>4 days ago</timeline-title>
            <timeline-item :hollow="true">Suspendisse faucibus sem a ex porta.</timeline-item>
          </timeline>
        </vue-scroll>
      </el-col>
      <el-col :xs="24" :sm="12" :md="14" :lg="16" :xl="18">
        ...
        <div
          class="card-base card-shadow--medium flex column mb-30 pv-20 bg-primary"
          style="height:295px;"
        >
          <div class="ph-20">
      ...
      list: [
        {
          ...
          email: "fmaclaverty0@scribd.com",
          gender: "Female",
          ip_address: "165.9.197.163"
        },
        {
          activity: 111,
          progress: 55,
        ...
        },
        {
          ...
          first_name: "Clayborn",
          last_name: "Blencoe",
          email: "cblencoe2@cbc.ca",
          gender: "Male",
          ip_address: "237.146.154.222"
        },
        {
          activity: 111,
          progress: 12,
          ...
          first_name: "Elna",
          last_name: "Deboick",
          email: "edeboick5@4shared.com",
          gender: "Female",
          ip_address: "53.209.210.199"
        },
        {
          activity: 111,
          progress: 0,
          ...
          first_name: "Sheffie",
          last_name: "Fellgett",
          email: "sfellgett7@ow.ly",
          gender: "Male",
          ip_address: "219.29.191.217"
        }
